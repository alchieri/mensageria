...
public interface BotEngineService {
     ...
     */
    boolean tryTriggerBot(Company company, Contact contact, UserSession session, User systemUser, WhatsAppPhoneNumber channel);

    /**
     * Processa a resposta do usuário para um bot que JÁ está rodando.
     */
    void processInput(String input, Contact contact, UserSession session, User systemUser, WhatsAppPhoneNumber channel);
}
